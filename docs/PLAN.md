...
| A1 | **Incident context** — the first user message contains an inline muted CASE-001 mention with foreground text and one accent pebble, while compact Munich and Stuttgart plant context shows the 6204-2RS bearing shortage |
