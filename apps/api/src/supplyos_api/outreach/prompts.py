...
by the planner, so the legal opener stays inside quotes. The task stays short:
CALL-E's planner returns 503 on a long compile.

The supplier's phone number never appears here — it travels separately
in the singular recipient object of the CALL-E request body.
"""
