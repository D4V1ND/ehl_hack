...
from supplyos_api.deps import erp, store
from supplyos_api.casestore.case_store import CaseStore
from supplyos_api.launch.devin import start_session
from supplyos_api.launch.incident import incident_for_part
...
def open_case(
    ...
    base_url = _public_api_url(request)
