...
Use the arrow keys, space bar, or the on-screen controls. Each forward action
reveals one point before moving to the next slide. Press `O` for the slide
overview and `F` for fullscreen. Slide 5 uses the saved SupplyOS case screen
and links to the live demo. Slide 6 compares the external supplier-search
